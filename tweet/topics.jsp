...
out.print("<font style='color:navy'><br><a href='addTopic.jsp'>Add P_Topic</a></p>");
...
ps1=con.prepareStatement("select *  from Topics where subject= ?");
...
rs=ps1.executeQuery();
%>
<tr bgcolor='gray'><th width="400"><font color=white><%=cat%> <font color=yellow style=normal>(<%=count%>)</font></th><td><td align="right" bgcolor='white' BORDERCOLOR="gray" width="400"><a href=addOpinion.jsp?subject=<%=cat%>>Add PO_Tweet</a></td></tr>
<%
while(rs.next())
{
