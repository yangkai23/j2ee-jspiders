...
public class MyListener implements ServletContextListener{
	...
	try{
		...
		con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","email","email");
		/*
		...
		stmt.executeUpdate("CREATE TRIGGER  BI_MAILCASTINGUSER before insert on MAILCASTINGUSER for each row begin select JAVATPOINT.nextval into :NEW.ID from dual; end");
